...
async def ensure_dashboard(hass: HomeAssistant, entry_id: str | None = None) -> None:
    ...
    for config_entry in hass.config_entries.async_entries("mam_manager"):
        for reg_entry in er.async_entries_for_config_entry(ent_reg, config_entry.entry_id):
            ...
            elif uid.endswith("_config_username"):
                entity_ids["config_username"] = reg_entry.entity_id
            elif uid.endswith("_password_preview"):
                entity_ids["password_preview"] = reg_entry.entity_id
            ...
            elif uid.endswith("_mbsc_preview"):
                entity_ids["mbsc_preview"] = reg_entry.entity_id
